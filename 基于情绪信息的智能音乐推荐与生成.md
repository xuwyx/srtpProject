...
- 徐维亚：
  ...
  - 专业：计算机科学与技术
- 秦子谦：
  - 身份证：320402199610142218
  - 专业：计算机科学与技术
- 钱佳一：330382199711120921
  - 身份证：330382199711120921
  - 专业：计算机科学与技术
...
点击Generate按钮，将会跳出对话框，此时需要输入希望保存的midi文件的文件路径和文件名：

![](save.png)

输入保存文件信息后，将会进入一个选择V-A值的界面，用户将鼠标移动至中间圆形坐标区域，在下方会显示该坐标值对应的V-A值，单击即开始生成对应情绪的音乐midi文件：

![](set_VA.png)

随机生成的midi文件可以用garageBand(Mac)软件打开，即可正常播放，欣赏到机器生成的美妙音乐了，如下：
